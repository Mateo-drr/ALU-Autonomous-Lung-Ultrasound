...
set "AMENT_ENVIRONMENT_HOOKS[us_msg]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[us_msg] "%AMENT_CURRENT_PREFIX%\share\us_msg\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[us_msg] "%AMENT_CURRENT_PREFIX%\share\us_msg\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[us_msg]:;=";"%") do (
    call:call_file %%f
  )
