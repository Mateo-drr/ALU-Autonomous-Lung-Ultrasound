...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\us_msg\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\us_msg\hook\path_dll.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\us_msg\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/us_msg/local_setup.bat"
