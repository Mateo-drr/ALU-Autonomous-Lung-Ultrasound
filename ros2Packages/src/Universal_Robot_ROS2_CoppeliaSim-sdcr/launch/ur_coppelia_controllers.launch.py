...
def generate_launch_description():
    ...
    # Save robot_description as a URDF file
    urdf_name = ur_type + ".urdf"
    urdf_path = os.path.join(description_package,"urdf", urdf_name)
    if not os.path.exists(urdf_path):
        file_handle = open(urdf_path, "x")
        robot_description_content.writexml(file_handle)
        file_handle.close()
        print("Saved robot_description as a URDF file")
