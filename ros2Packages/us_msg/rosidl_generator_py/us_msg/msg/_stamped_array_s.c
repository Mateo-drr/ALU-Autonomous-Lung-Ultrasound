...
bool us_msg__msg__stamped_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("us_msg.msg._stamped_array.StampedArray", full_classname_dest, 38) == 0);
  }
  us_msg__msg__StampedArray * ros_message = _ros_message;
  {  // stamp
  ...
  {  // array
    ...
    if (!std_msgs__msg__float32_multi_array__convert_from_py(field, &ros_message->array)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of StampedArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("us_msg.msg._stamped_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StampedArray");
  ...
  {  // array
    PyObject * field = NULL;
    field = std_msgs__msg__float32_multi_array__convert_to_py(&ros_message->array);
    if (!field) {
      return NULL;
    }
    {
